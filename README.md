...
| [`com.faolline.graphgameflow`](com.faolline.graphgameflow/) | 0.13.1 | The `MonoBehaviour`/scene adapter — drives a graph live in a Unity scene |
| [`com.faolline.graphgameflow.addressables`](com.faolline.graphgameflow.addressables/) | 0.1.0 | Bridges graphgameflow's scene loader to `com.unity.addressables` |
