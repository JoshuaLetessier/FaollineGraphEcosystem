...
| [`com.faolline.graphgameflow`](com.faolline.graphgameflow/) | 0.15.1 | The `MonoBehaviour`/scene adapter — drives a graph live in a Unity scene |
...
| [`com.faolline.graphsave.savesystem`](com.faolline.graphsave.savesystem/) | 0.1.7 | Bridges graphsave to `com.faolline.savesystem.core` (UnitySaveSystem) |
