    ...
    public class TestIntCondition : BaseCondition
    {
        ...
        public override bool Evaluate(BaseContext context)
        {
            ...
            try
            {
                ...
                {
                    Debug.LogWarning($"[GraphTest] Condition: int parameter '{_parameterKey}' not found in context — evaluating to false.");
                    return false;
                }
            }
            catch (System.InvalidCastException)
            {
                Debug.LogWarning($"[GraphTest] Condition: parameter '{_parameterKey}' is not an int — evaluating to false.");
                return false;
            }
