...
namespace Faolline.GraphTest
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "GraphTest/Conditions/Int Condition", fileName = "IntCondition")]
    public class TestIntCondition : BaseCondition
    {
        ...
        public override bool Evaluate(BaseContext context)
        {
            ...
            try
            {
                ...
                {
                    Logging.Warning("GraphTest", $"[GraphTest] Condition: int parameter '{_parameterKey}' not found in context — evaluating to false.");
                    return false;
                }
            }
            catch (System.InvalidCastException)
            {
                Logging.Warning("GraphTest", $"[GraphTest] Condition: parameter '{_parameterKey}' is not an int — evaluating to false.");
                return false;
            }
