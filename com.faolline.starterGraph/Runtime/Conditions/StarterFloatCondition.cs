...
namespace Faolline.StarterGraph
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "StarterGraph/Conditions/Float Condition", fileName = "FloatCondition")]
    public class StarterFloatCondition : BaseCondition
    {
        ...
        public override bool Evaluate(BaseContext context)
        {
            ...
            try
            {
                ...
                {
                    Debug.LogWarning($"[StarterGraph] Condition: float parameter '{_parameterKey}' not found in context — evaluating to false.");
                    return false;
                }
            }
            catch (System.InvalidCastException)
            {
                Debug.LogWarning($"[StarterGraph] Condition: parameter '{_parameterKey}' is not a float — evaluating to false.");
                return false;
            }
