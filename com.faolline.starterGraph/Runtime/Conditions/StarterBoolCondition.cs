...
namespace Faolline.StarterGraph
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "StarterGraph/Conditions/Bool Condition", fileName = "BoolCondition")]
    public class StarterBoolCondition : BaseCondition
    {
        ...
        public override bool Evaluate(BaseContext context)
        {
            ...
            {
                Debug.LogWarning($"[StarterGraph] Condition: parameter key '{_parameterKey}' not found in context — evaluating to false.");
                return false;
            }
