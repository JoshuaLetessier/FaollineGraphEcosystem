...
namespace Faolline.StarterGraph
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "StarterGraph/Conditions/String Condition", fileName = "StringCondition")]
    public class StarterStringCondition : BaseCondition
    {
        ...
        public override bool Evaluate(BaseContext context)
        {
            ...
            try
            {
                ...
                {
                    Debug.LogWarning($"[StarterGraph] Condition: string parameter '{_parameterKey}' not found in context — evaluating to false.");
                    return false;
                }
            }
            catch (System.InvalidCastException)
            {
                Debug.LogWarning($"[StarterGraph] Condition: parameter '{_parameterKey}' is not a string — evaluating to false.");
                return false;
            }
