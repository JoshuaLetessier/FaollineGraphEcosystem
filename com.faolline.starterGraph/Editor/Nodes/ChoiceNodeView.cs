...
namespace Faolline.StarterGraph.Editor
{
    ...
    /// <c>ChooseById</c>); its displayed label is the choice's <see cref="StarterChoice.Label"/>.
    ...
    public class ChoiceNodeView : BaseNodeView
    {
        ...
        /// displayed connector label = the choice's <see cref="StarterChoice.Label"/>.
        /// </summary>
        ...
        {
            if (choice is StarterChoice tc && !string.IsNullOrEmpty(tc.Label))
                return tc.Label;
