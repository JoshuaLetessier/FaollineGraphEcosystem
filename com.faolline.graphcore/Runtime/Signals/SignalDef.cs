...
namespace Faolline.GraphCore
{
    ...
    /// <see cref="CollectionEntry"/>/<see cref="CollectionDef"/> and <see cref="BaseGraph.GraphId"/>. That
    ...
    /// GUID) or a held <see cref="SignalDef"/> reference.
    /// </para>
    /// </summary>
    ...
    public class SignalDef : ScriptableObject, IStableGuidIdentity
    {
        ...
        public static implicit operator string(SignalDef signal)
            => signal != null ? signal.Key : string.Empty;

        /// <summary>
        /// Creates a runtime <see cref="SignalDef"/> instance with a fresh GUID identity and the given
        ...
        /// </summary>
        public static SignalDef Create(string displayName)
        {
            var s = CreateInstance<SignalDef>();   // OnEnable assigns _id
            s._name = displayName;
            return s;
        }
    }
