...
{
    /// <summary>
    /// LogAction. The implementation now lives in <see cref="Faolline.GraphCore.LogAction"/> — hoisted to GraphCore so a
    ...
    /// should prefer <see cref="Faolline.GraphCore.LogAction"/> directly.
    /// </summary>
